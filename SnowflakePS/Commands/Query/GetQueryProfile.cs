        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                Parallel.For(0, this.QueryIDs.Length, (queryIndex, stateQueries) =>
                {
                    ...
                    // First, get details
                    string queryDetailsApiResult = SnowflakeDriver.GetQueryDetails(this.AuthContext, queryID, this.Role);
                    ...
                    {
                        // Only get latest
                        string queryProfileApiResult = SnowflakeDriver.GetQueryProfile(this.AuthContext, queryID, this.Role);
                    ...
                    else
                    {
                        ...
                        {
                            string queryProfileApiResult = SnowflakeDriver.GetQueryProfile(this.AuthContext, queryID, this.Role, retryNumber);
                            if (queryProfileApiResult.Length == 0)
                            {
